...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://orangedragon-blog.site",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/logo/OrangeDragon.png",
			valueDark: "assets/images/logo/OrangeDragon.png",
			alt: "🍀",
		},
		// 导航栏标题
		title: "OrangeDragon111",
		// 全宽导航栏，导航栏是否占满屏幕宽度
		widthFull: false,
